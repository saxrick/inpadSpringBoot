    ...
    handleButtonDown(event, button) {
        ...
        if (button === 0 && this.state === '') {
            ...
            if (this.mode === 'box') {
                ...
                const geometry = new THREE.BufferGeometry().fromGeometry(new THREE.CylinderGeometry(0.5, 0.5, 1, 16));
                const material = new THREE.MeshPhongMaterial({ color: 0x00ff00 });
                this.mesh = new THREE.Mesh(geometry, material);
                this.mesh.rotation.x = Math.PI / 2; // rotate the cylinder to stand upright
            ...
            return true; // Stop the event from going to other tools in the stac
        }
