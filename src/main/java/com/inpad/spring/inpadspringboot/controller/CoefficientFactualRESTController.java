...
public class CoefficientFactualRESTController {
    ...
    @GetMapping("/{id}")
    public CoefficientFactual getCoefficientFactual(@PathVariable int id){
    ...
    @PutMapping("/{id}")
    public void updateCoefficientFactual(@RequestBody CoefficientFactual coefficientFactual, @PathVariable int id){
