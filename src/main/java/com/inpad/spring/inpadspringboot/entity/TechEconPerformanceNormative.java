...
//    private int objectSubtype;
    ...
    public TechEconPerformanceNormative() {
    }

    public TechEconPerformanceNormative(Long id, int floorNum, double apartsArea, double commArea, double douArea, int apartsParkingSpotAmount, int commParkingSpotAmount, double residentsNum, double douPlacesNum, double souPlacesNum, double totalDouArea, double totalPlaygroundArea, double totalSportgroundArea, double totalRecreationArea, double totalUtilArea) {
        this.id = id;
